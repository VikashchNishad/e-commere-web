...
// Sample factory (dummy)
  ...
  .factory('Product', ['$resource', function($resource) {
    ...
    obj.percentOff = $resource('/api/discounts/:id/percentOff', null, {'update': { method:'PUT' } });
    obj.rsOff = $resource('/api/discounts/:id/rsOff', null, {'update': { method:'PUT' } });
    obj.buyDiscount = $resource('/api/discounts/:id/buyDiscount', null, {'update': { method:'PUT' } });
